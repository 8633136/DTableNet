...
def main():
    ...
    line_post = Line_Postprocess(
                            ...
                            iou=0.7)
    # save low score img
    save_low_score_folder = "/home/li/Desktop/disk2/wy/TableRe/FsrcnnNet_class_2/low_score_img_boxes"
    low_score_thr = 0.5
    low_score_list = []
    for id,img in enumerate(img_list):
        ...
        data_transform = my_transforms.Compose([my_transforms.ToTensor(),
                                        my_transforms.Normalize(mean=[0.5, 0.5, 0.5], std=[0.5, 0.5, 0.5]),
        ...
        with torch.no_grad():
            ...
            for one_id,pred in enumerate(p2_c):
                ...
                if score<low_score_thr:
                    ...
                    # plt.show()
                    # 保存预测的图片结果
                    # plot_img.save(os.path.join(save_low_score_folder,filename_list[one_id]))
