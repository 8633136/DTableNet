...
def main():
    ...
    box_thresh = 0.9
    # save low score img
    save_low_score_folder = "./low_score_img_boxes_tems"
    low_score_thr = 0.8
    ...
    for id,img in enumerate(img_list):
        ...
        with torch.no_grad():
            ...
            for one_id,pred in enumerate(p2_c):
                ...
                score,point_row,point_col,headnum = line_post.Get_score_out(thr_row=row,thr_col=col,merge_boxs=merge_boxs,
