...
if __name__ == "__main__":
    little_train_txt = r"/home/li/Desktop/disk2/datasets/pubtabnet/voc_pubtabnet_val2train/val.txt"
    ...
    save_little_dataset_root_path = r"/home/li/Desktop/disk2/datasets/pubtabnet/voc_pubtabnet_val2train"
    ...
    for name in train_name_list:
        ...
        if not os.path.exists(ori_anno_file):
            continue
