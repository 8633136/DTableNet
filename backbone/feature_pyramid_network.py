...
class BackboneWithFPN(nn.Module):
    ...
    def __init__(self,
        ...
        self.CBAM_in_channels = 256
        self.ca = ChannelAttention(self.CBAM_in_channels)
        self.sa = SpatialAttention()
        # self.CBAM_in_channels2 = 256
        # self.ca1 = ChannelAttention(self.CBAM_in_channels2)
    ...
    def forward(self, x):
        ...
        x['0'] = self.ca(x['0'])*x['0']
        x['0'] = self.sa(x['0'])*x['0']
        # x['1'] = self.ca1(x['1']) * x['1']
        # x['1'] = self.sa1(x['1']) * x['1']
        return x
