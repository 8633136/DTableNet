...
def main():
    ...
    weights_path = "./725_serve_test_convt/low_all/resNetFpn-model-33.pth"
    ...
    img_folder = "./save_low_score_tablemaster"
    # imgname_file = r""
    # f = open(imgname_file,"r")
    # data_imgnames = json.load(f.read())
    # f.close()
    # img_list = data_imgnames
    # # for name in data_imgnames.keys():
    ...
    box_thresh = 0.9
    # save low score img
    save_low_score_folder = "./low_score_for_tablemaster_low_0.9_epoch33"
