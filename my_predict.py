...
def main():
    ...
    img_folder = "/home/li/Desktop/disk2/datasets/pubtabnet/voc_dence_true_thr_4/JPEGImgages_val_dence"
    img_folder = "/home/li/Desktop/disk2/datasets/pubtabnet/voc_dence_true_no800_thr_3.5/JPEGImgages_val_dence"
    ...
    box_thresh = 0.9
    # save low score img
    save_low_score_folder = "./low_score_dence_thr4"
    low_score_thr = 0.8
...
def my_val(model,device):
    ...
    box_thresh = 0.9
    # save low score img
    save_low_score_folder = "./low_score_train_low_0.8_epoch26"
    low_score_thr = 1.0
    low_score_folder_list = ['0.8-0.6', '0.6-0.4', '0.4-0.0']
    low_score_thr_list = [0.6, 0.4, 0.0]
    for low_folder in low_score_folder_list:
