...
#                      aspect_ratios,dtype=torch.float32, device=torch.device("cpu")):
...
#
# print(generate_anchors(anchor_sizes1,aspect_ratios1),
#       generate_anchors(anchor_sizes1,aspect_ratios1).shape
#     )
