...
def main():
    ...
    weights_path = "./723_serve_test_convt/resNetFpn-model-28.pth"
    ...
    img_folder = "/home/li/Desktop/disk2/datasets/pubtabnet/one_img_get_thr_map"
    # img_folder = "/home/li/Desktop/disk2/datasets/pubtabnet/pubtabnet_sim_com/pubtabnet_sim_com/simple"
    # img_folder = "/home/li/Desktop/disk2/datasets/pubtabnet/voc_dence_true_no800_thr_4d2/JPEGImgages_val_dence"
    ...
    line_post = Line_Postprocess(
                            ...
                            DBPost_merge=[],
                            teds=TEDS(n_jobs=2,structure_only=True),
                            gt_val_file=gt_val_file,
    ...
    box_thresh = 0.75
    # save low score img
    save_low_score_folder = "./A_epoch36_complex_box_thr_0d7"
    ...
    for id,img in enumerate(img_list):
        ...
        with torch.no_grad():
            ...
            row = row.repeat(128,axis=0)
            # cv2.imshow("thr map",row)
            # cv2.waitKey(0)
            cv2.imwrite("./save_conv_proj.png",row)
